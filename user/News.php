        ...
        <div class="header-right">
          ...
          <div>
            <ul class="ul-nav">
              ...
              <li>
                <a href="./news.php">
                  <span style="padding: 6px 20px;background-image: url('./img/bg-tit.png');background-repeat: no-repeat;" class="News-link">News</span>
                </a>
              </li>
              <li>
                <a href="./gallery.php">
...
<div class="page-news bg-abe">
    <div class="container">
        <div class="news-box">
            <div class="list-news-k">
                <ul>
                    <li>
                        <div class="item">
                            <div class="news-k"></div>
                            <a href="" class="avt">
