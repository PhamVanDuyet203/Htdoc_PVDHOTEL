...
<body>
        ...
        <div class="header-right">
          ...
          <div>
            <ul class="ul-nav">
              ...
              <li>
                <a href="#">
                  <span style="padding: 6px 20px;	background-image: url('./img/bg-titH2.png');
                  background-repeat: no-repeat;" class="Tour-link">Tour travel</span>
                </a>
              </li>
              <li>
                <a href="./service.php">
  ...
  <div class="banner">
    <div class="banner-title">
        <div class="avt">
          <img src="img/banner-travel.jpg" alt="" width="100%">
        </div>
        <div class="desc">
            <h1>
...
<div class="page-tourtravel bg-abe">
    <div class="container">
        <div class="short-desc">
            <p style="text-align: center;">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer vel molestie nisl. Duis ac mi leo. Mauris at convallis erat. Aliquam interdum semper luctus. Aenean <br>
        ...
        <div class="our-tour">
            <h2 class="titH2-travel">
                <span style="font-weight: 700;">Our Tours</span>
            </h2>
            <div class="list-our-tour">
                <ul>
                    <li>
                        <a href="" class="item">
                            <div class="avt">
                                <img src="img/our-tour.jpg" alt="">
                            </div>
                            <div class="box-layer">
                                <div class="desc">
                                    <div class="desc-midle">
                                        <h3>
                                            <span>BICH DONG PAGODA <br>
                                                    MUA CAVE - PHAT DIEM CATHEDRAL </span>
                                        </h3>
                                    </div>
                                </div>
                            </div>
