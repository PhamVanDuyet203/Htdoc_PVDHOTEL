...
<body style="background-image: url(img/banner.jpg);background-repeat: no-repeat;background-size:contain; height: 100vh;background-position: 250px 0;">
    <div id="wrapper">
    ...
    font-size: 50px;
    color: white;
    font-weight: 700;">PVDHOTEL</h1>

    <div id="footer-sec" style=" position: fixed;
    bottom: 0;
    left: 0;
    width: 100%;
